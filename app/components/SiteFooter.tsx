    ...
    <footer className="site-footer">
      <div className="container-wide footer-top">
        <div className="footer-brand">
          <Image
            src="/smf-emblem.png"
            alt="Support &amp; Mentor Foundation"
            width={52}
            height={52}
          />
          <div className="fb-name">Support &amp; Mentor Foundation</div>
          <p>
            Protecting, mentoring, and empowering vulnerable children and young
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li>
              <Link href="/get-involved#fundraise">Fundraise</Link>
            </li>
          </ul>
        </div>
      ...
      <div className="container-wide footer-bottom">
        <span>
          © 2026 Support &amp; Mentor Foundation. All rights reserved.
        </span>
